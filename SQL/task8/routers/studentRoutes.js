...
// departwithstudents
router.post("/adddepartmentwithstudents",studentsControllers.CreateDepartWithStudents);

// getdepartwithStudents
router.get("/departmentwithstudents",studentsControllers.FetchDepartWithStudents);
